...
|---|---|---|
| `tests/leb128.sh` | the weight reader matches the FORMAT, not just the shipped net | this page |
| `tests/fuzz.py --harness net` | a corrupt network is refused rather than loaded and reported as an opinion | [10-tooling-ci.md](10-tooling-ci.md) |
...
`tests/malformed.sh` asks the same question of the tablebase reader ([05-tablebases.md](05-tablebases.md)), and the two exist for the
